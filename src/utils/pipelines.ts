...
//
// `media` is a placeholder for now — there are no animation assets yet. To add a
// real visual later, drop a file in assets/pipelines/ and set e.g.
//   media: { type: "gif", src: "/assets/pipelines/tfidf-tokenize.gif" }

export type StepMedia = {
  type: "gif" | "video" | "lottie" | "placeholder";
  src?: string;
  alt?: string;
};
...
const placeholder: StepMedia = { type: "placeholder" };
